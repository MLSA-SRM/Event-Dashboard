...
import { LineChart, Line, CartesianGrid, YAxis, XAxis, PieChart, Pie, Cell } from 'recharts';
import './info.css';
		...
		<div>
			...
			<div className="body">
				<div className="box">
					...
					<LineChart width={440} height={250} data={data} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
						<Line type="monotone" strokeWidth="2" dataKey="uv" stroke="#8884d8" />
						<CartesianGrid stroke="#ccc" strokeWidth="1" strokeDasharray="0 0" />
						<XAxis dataKey="name" />
						<YAxis />
					</LineChart>
				</div>
